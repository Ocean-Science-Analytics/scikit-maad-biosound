...
# Import the marine calculation functions
# Need to import as module since filename has hyphens
import importlib.util
spec = importlib.util.spec_from_file_location("gui_module", "SciKit_Maad_File_Processing-GUI.py")
gui_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(gui_module)

calculate_marine_biophony_anthrophony = gui_module.calculate_marine_biophony_anthrophony
calculate_marine_indices = gui_module.calculate_marine_indices
